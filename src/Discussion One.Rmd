...
### Pie Chart: The Number of Tournaments per Game Genre 
```{r}
pie <- ggplot(data = Esports, mapping = aes(x= "", y = TotalTournaments, fill=Genre)) +
...
### Line Chart: Comparing Total Number Of Tournaments and Prize Money per Game
```{r}
ggplot(data = teamProgression , aes(x = TotalTournaments , y = TotalUSDPrize/100)) +
        ...
        labs(title = "Number of Tournaments vs Total Prize Money Won Per Game" ,
...
### Scatterplot: Comparing total amount of tournaments and total prize money won
